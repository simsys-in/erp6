...
function Sidebar() {
  ...
  const ToggleClass = () => {
    ...
    return (
        <div id="app-sidepanel" className="app-sidepanel " onClick={ToggleClass}>
            <div id="sidepanel-drop" className="sidepanel-drop"></div>
            <div className="sidepanel-inner d-flex flex-column">
                <a href="#" id="sidepanel-close" className={isActive ? "active" : '' + "sidepanel-close d-xl-none"}>&times;</a>
                <div className="app-branding">
                    <a className="app-logo" href="#"><img className=" me-2" src="assets/images/logo.png" width="180" alt="logo" /></a>
                ...
                <nav id="app-nav-main" className="app-nav app-nav-main flex-grow-1">
                    <ul className="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li className="nav-item mnu-byrole mnu-admin nav-link">
                            <Link to="/ledger">
                                <span className="nav-icon">
                        ...
                        <li className="nav-item mnu-byrole mnu-admin ">

                            <a className="nav-link" href="#forex_user">
                                <span className="nav-icon">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z" />
                                        <path fillRule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z" />
                                ...
                                <span className="nav-link-text">Forex User</span>
                            </a>
                        </li>
                        ...
                        <li className="nav-item mnu-byrole mnu-admin ">
                            ...
                            <a className="nav-link" href="#forex_order">
                                <span className="nav-icon">
                                ...
                                <span className="nav-link-text">Forex Order</span>
                            </a>
                        </li>

                        <li className="nav-item mnu-byrole mnu-employee ">

                            <a className="nav-link" href="#core_user">
                                <span className="nav-icon">
                        ...
                        <li className="nav-item mnu-byrole mnu-employee ">
                            ...
                            <a className="nav-link" href="#forex_deposit">
                                <span className="nav-icon">
                        ...
                        <li className="nav-item mnu-byrole mnu-employee ">
                            ...
                            <a className="nav-link" href="#forex_withdraw">
                                <span className="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-people" viewBox="0 0 16 16">
                                        <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10A5.493 5.493 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z" />
                                    </svg>
                        ...
                        <li className="nav-item has-submenu mnu-byrole mnu-admin1 ">
                            ...
                            <a className="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
                                ...
                                <span className="nav-link-text">Forex Reports</span>
                            ...
                            <div id="submenu-2" className="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul className="submenu-list list-unstyled">
                                    <li className="submenu-item"><a className="submenu-link" href="#frex_report/deposit">Deposit</a></li>
                                    <li className="submenu-item"><a className="submenu-link" href="#forex_report/withdraw">Withdrawal</a></li>
                                    <li className="submenu-item"><a className="submenu-link" href="#forex_report/users">Users</a></li>
                                    <li className="submenu-item"><a className="submenu-link" href="#forex_report/order_daybook">Order Daybook</a></li>
                                    <li className="submenu-item"><a className="submenu-link" href="#forex_report/order_daybook">Order Daybook</a></li>
                                    <li className="submenu-item"><a className="submenu-link" href="#forex_report/orders_byposition">Positions</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li className="nav-item has-submenu mnu-byrole mnu-admin1 ">
                            ...
                            <a className="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-3" aria-expanded="false" aria-controls="submenu-2">
                                ...
                                <span className="nav-link-text">MT Reports</span>
                                <span className="submenu-arrow">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                    </svg>
                            ...
                            <div id="submenu-3" className="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                                <ul className="submenu-list list-unstyled">
                                    <li className="submenu-item"><a className="submenu-link" href="#forex_report/mt_orders">MT Orders</a></li>
                                </ul>
                            </div>
                        </li>
