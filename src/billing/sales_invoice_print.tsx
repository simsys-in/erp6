import { Badge, Button, ButtonGroup, ButtonToolbar, Card, Col, Container, Dropdown, DropdownButton, Form, FormControl, InputGroup, Row, SplitButton, Table, Toast, ToastContainer } from 'react-bootstrap'
import { Link, Redirect, useParams } from "react-router-dom";
import * as Icons from 'react-bootstrap-icons';
import Middleware from '../tools/Middleware';
import Tspdf from "../tools/Tspdf"
