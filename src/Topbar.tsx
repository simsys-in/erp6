...
import { dataContext, menuContext, routeContext } from './dataContext';
...
<a id="sidepanel-toggler" className="sidepanel-toggler d-inline-block d-xl-none" href="#" onClick={() => setActive(!isActive)}>
...
<div className="col">
<div className="info">
<div className="desc">Forex Payment Approvel</div>
<div className="meta"> 2 records waiting</div>
</div>
</div>
</div>
<a className="link-mask" href="#notifications"></a>
</div>
</div>
...
<a className="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img className="employee_profile" src="/asset/image/noprofileimage.png" alt="user profile" /></a>

<ul className="dropdown-menu" aria-labelledby="user-dropdown-toggle">
<li className="h5"><span className="dropdown-item badge bg-success employee_name">{user_info.name}</span></li>
<li><a className="dropdown-item"><i className="fas fa-mobile-alt"></i> {user_info.mobile}<span className="employee_mobile_no"></span></a></li>
<li><a className="dropdown-item"><i className="far fa-envelope"></i> {user_info.email}<span className="employee_email"></span></a></li>
...
<div id="app-sidepanel" className={"app-sidepanel d-print-none " + (isActive ? 'sidepanel-visible' : 'sidepanel-hidden')}>
<div id="sidepanel-drop" className="sidepanel-drop"></div>
<div className="sidepanel-inner d-flex flex-column">
<a href="#" id="sidepanel-close" className="sidepanel-close d-xl-none" onClick={() => setActive(!isActive)}>&times;</a>
<div className="app-branding">
<a className="app-logo" href="#"><img className=" me-2" src="/asset/image/logo.png" width="180" alt="logo" /></a>
...
{/* <li className="nav-item  nav-link"><Link to="/receipt_note"><span className="nav-icon"><Icon.PersonBadgeFill /></span><span className="nav-link-text">Receipt Note</span></Link></li> */}
<li className="nav-item  nav-link"><Link to="/jewellery/sales_invoice"><span className="nav-icon"><Icon.CartCheckFill /></span><span className="nav-link-text">Sales Invoice</span></Link></li>
<li className="nav-item  nav-link"><Link to="/billing/sales_invoice"><span className="nav-icon"><Icon.CartCheckFill /></span><span className="nav-link-text">Sales Invoice</span></Link></li>
...
<li className="submenu-item"><Link to="/billing/ledger" className="submenu-link">Ledger</Link></li>
<li className="submenu-item"><Link to="/core/ledger_category" className="submenu-link">Ledger Category</Link></li>
<li className="submenu-item"><Link to="/core/ledger_group" className="submenu-link">Ledger Group</Link></li>
</ul>
</div>
</li>
...
<a className="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-3" aria-expanded="false" aria-controls="submenu-2">
...
<li className="submenu-item"><Link to="/core/user_group" className="submenu-link">User Group</Link></li>
</ul>
</div>
</li>
...
<a className="nav-link" href="https://download.mql5.com/cdn/web/link2link.forex.limited/mt5/link2linkforex5setup.exe">
<span className="nav-icon">
...
<a className="nav-link" href="#license">
<span className="nav-icon">
